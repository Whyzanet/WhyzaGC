...
unsigned long mqtt_delay = 0;  // mtqq broker upload sensor data interval ( CPM and Sieverts )
TaskHandle_t Task3;
char mqttbuffer[10];
const char* mqttValue = mqttbuffer;
unsigned long mqtt_online_update_interval = 0;  // update the mqtt broker online status at this interval
