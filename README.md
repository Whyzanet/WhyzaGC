...
The other difference between the ESP8266 and the ESP32 code is that the ESP32 Neopixel every 60 secs will flash purple when starting the radmon.org update and then flash green when having completed a successful update attempt, or flash red for an unsuccessful update attempt.
