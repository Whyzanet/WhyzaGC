...
Vaseline glass contains uranium which makes it a useful item for background level radiation testing ( as are granite kitchen benchtops I hear ). The piece of Vaseline glass I have will cause a count of around 135 CPM when up close to the detector tube.
