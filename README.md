...
Adafruit Feather Huzzah ESP32 v2 pinout. ADC2 is used by WiFi if enabled and not available for IO. Pin 32 is also not available as it is used by the ABC buttons on the sreen.
