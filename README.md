...
I also picked up from United Nuclear uranium ore chunks, a geiger counter test card and a Fiestaware plate, which has the greatest radiation of all the samples I have.
...
I am connecting the VBUS/USB pin on the Huzzah to a Raspberry Pi 5V pin via the Pi GPIO header ( any decent 5v supply will suffice), as well as a ground connection between the two boards. Current is usually around 110 mA, though will peak around 300 mA when charging the Li-Po battery.
