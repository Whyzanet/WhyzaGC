...
const char* release = "WhyzaGC v4.7";  // Version 4 adds MQTT support and a few tidy ups. Not released for ESP8266 at this stage. Use v 3.6 for ESP8266
const char* releasedate = "Released 10/5/2024";
...
void wifion() {  //enable WiFi
  ...
  if (WiFi.waitForConnectResult() == WL_CONNECTED) {
    ...
    if (NTPEnable == 1) {
      // if (NTPEnable == 1 && (NTP_Use_Hostname == 1)) {
