...
const unsigned char radiationicon [] PROGMEM = {
  ...
  , 
...
void histogramData () { //Graph Data, autoscale max 16, 32, 64, 128, 256
  ...
  for (decltype(xpoints)::index_t i = 0; i <= xpoints.size(); i++) {
    ...
    for (decltype(xpoints)::index_t i = 0; i <= xpoints.size(); i++) {
      ...
      if ( xpoints[i] < 32769 && xpoints[i] >= 16385 && scale13 == false ) {
        recenthi = 12;
        scale12 = true;
      }
      if ( xpoints[i] < 16385 && xpoints[i] >= 8193 && scale13 == false && scale12 == false ) {
        recenthi = 11;
        scale11 = true;
      }
      if ( xpoints[i] < 8193 && xpoints[i] >= 4097 && scale13 == false && scale12 == false && scale11 == false ) {
        recenthi = 10;
        scale10 = true;
      }
      if ( xpoints[i] < 4097 && xpoints[i] >= 2049 && scale13 == false && scale12 == false && scale11 == false && scale10 == false ) {
        recenthi = 9;
        scale9 = true;
      }
      if ( xpoints[i] < 2049 && xpoints[i] >= 1025 && scale13 == false && scale12 == false && scale11 == false && scale10 == false && scale9 == false ) {
        recenthi = 8;
        scale8 = true;
      }
      if ( xpoints[i] < 1025 && xpoints[i] >= 513 && scale13 == false && scale12 == false && scale11 == false && scale10 == false && scale9 == false  && scale8 == false ) {
        recenthi = 7;
        scale7 = true;
      }
      if ( xpoints[i] < 513 && xpoints[i] >= 257 && scale13 == false && scale12 == false && scale11 == false && scale10 == false && scale9 == false  && scale8 == false && scale7 == false ) {
        recenthi = 6;
        scale6 = true;
      }
      if ( xpoints[i] < 257 && xpoints[i] >= 129 && scale13 == false && scale12 == false && scale11 == false && scale10 == false && scale9 == false  && scale8 == false && scale7 == false && scale6 == false ) {
        recenthi = 5;
        scale5 = true;
      }
      if ( xpoints[i] < 129 && xpoints[i] >= 65 && scale13 == false && scale12 == false && scale11 == false && scale10 == false && scale9 == false  && scale8 == false && scale7 == false && scale6 == false && scale5 == false ) {
        recenthi = 4;
        scale4 = true;
      }
      if ( xpoints[i] < 65 && xpoints[i] >= 33 && scale13 == false && scale12 == false && scale11 == false && scale10 == false && scale9 == false && scale8 == false && scale7 == false && scale6 == false && scale5 == false && scale4 == false ) {
        recenthi = 3;
        scale3 = true;
      }
      if ( xpoints[i] < 33 && xpoints[i] >= 17 && scale13 == false && scale12 == false && scale11 == false && scale10 == false && scale9 == false && scale8 == false && scale7 == false && scale6 == false && scale5 == false && scale4 == false && scale3 == false ) {
        recenthi = 2;
        scale2 = true;
      }
      if ( xpoints[i] < 17 && xpoints[i] >= 9 && scale13 == false && scale12 == false && scale11 == false && scale10 == false && scale9 == false && scale8 == false && scale7 == false && scale6 == false && scale5 == false && scale4 == false && scale3 == false && scale2 == false ) {
        recenthi = 1;
        scale1 = true;
      }
      if ( xpoints[i] < 9 && xpoints[i] >= 1 && scale13 == false && scale12 == false && scale11 == false && scale10 == false && scale9 == false && scale8 == false && scale7 == false && scale6 == false && scale5 == false && scale4 == false && scale3 == false && scale2 == false && scale1 == false ) {
        recenthi = 0;
        scale0 = true;
      }
    }
