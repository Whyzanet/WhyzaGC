const char* release = "WhyzaGC v3.1";
const char* releasedate = "Released 22/9/2022";
...
void histogramData () { //Graph Data, autoscale max 16, 32, 64, 128, 256
  ...
  for (decltype(xpoints)::index_t i = 0; i <= xpoints.size(); i++) {
    ...
    for (decltype(xpoints)::index_t i = 0; i <= xpoints.size(); i++) {
      ...
      if ( xpoints[i] < 17 && xpoints[i] >= 9 && scale11 == false && scale10 == false && scale9 == false && scale8 == false && scale7 == false && scale6 == false && scale5 == false && scale4 == false && scale3 == false && scale2 == false ) {
        recenthi = 1;
        scale1 = true;
      }
      if ( xpoints[i] < 9 && xpoints[i] >= 1 && scale11 == false && scale10 == false && scale9 == false && scale8 == false && scale7 == false && scale6 == false && scale5 == false && scale4 == false && scale3 == false && scale2 == false && scale1 == false ) {
        recenthi = 0;
        scale0 = true;
      }
    }
